module glitch-desktop

go 1.25.0

require (
	github.com/8op-org/gl1tch v0.0.0
	github.com/wailsapp/wails/v2 v2.12.0
)

replace github.com/8op-org/gl1tch => ../
...
// replace github.com/wailsapp/wails/v2 v2.12.0 => /Users/stokes/go/pkg/mod
