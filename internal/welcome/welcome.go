// Package welcome is a thin shim that delegates to the deck package.
//
// The standalone welcome dashboard has been replaced by the Deck TUI.
...
// Run starts the GLITCH Deck. The busSocket parameter is accepted but
